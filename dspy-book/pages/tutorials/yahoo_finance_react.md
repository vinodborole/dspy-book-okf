...
Many Langchain tools use async operations for better performance. For details on async tools, see the [Tools documentation](../../learn/programming/tools/#async-tools).
...
1. Source page: https://dspy.ai/tutorials/yahoo_finance_react
