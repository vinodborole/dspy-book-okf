...
resource: https://dspy.ai/diving-deeper/tools
...
Read this page when you want to define, wrap, validate, or import tools. For the agent loop that decides when to call them, see [ReAct and ReActV2](../react/).
...
- [`dspy.Tool` API reference](../../api/primitives/Tool/)
- [`dspy.ToolCalls` API reference](../../api/primitives/ToolCalls/)

# Citations

1. Source page: https://dspy.ai/diving-deeper/tools
